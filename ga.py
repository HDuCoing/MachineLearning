...
import pylab as pl
import numpy as np
from main import fitnessFunction


class ga:

	def __init__(self,stringLength,fitnessFunction,nEpochs,populationSize,mutationProb=-1,crossover='un',nElite=4,tournament=True):
		""" Constructor"""
	...
	def runGA(self):
		...
		for i in range(self.nEpochs):
			...
			bestgene.append(self.population[np.argmax(fitness)])
		...
		pl.plot(bestfit,'kx-')
		pl.show()
		for genelist in bestgene:
			print(genelist)
		print("best gene ", bestgene[np.argmax(bestfit)])
